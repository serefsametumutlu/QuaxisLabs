...
- **Bu dosyanın kapsamı — KİTABIN TAMAMI (9 kısım, TAMAMLANDI):**
  - Chapter 1: Introduction to Valuation (PDF s.15-49) — Chapter 18: Closing Thoughts (PDF s.843-864).
  - PDF sayfa aralığı: 15-864 (s.865'ten itibaren Index, işlenmedi). Sayfa dönüşümü (doğrulanmadı, kitap geneli için teyit edilmedi): kitap sayfası ≈ PDF index − 14.
- **KİTAP TAMAMLANDI (2026-08-11):** Kısım 1-9 (Ch.1-18 + appendix'ler) TAMAMEN işlendi — bkz. aşağıdaki "Bölüm bazlı durum" tablosu ve "Kitap geneli TOPLAM sayılar" bloğu. Detaylı kısım-kısım tarihçe/notlar `_ilerleme.md`'de.
- **ID numaralandırması bu kitapta İLK turdur** — İLKE-01, FORMÜL-01, BAYRAK-01'den başlar, İLKE-469/FORMÜL-178/BAYRAK-83'e kadar KESİNTİSİZ/TEKRARSIZ devam eder (script ile doğrulandı). Kitaplar arası ID alanı BAĞIMSIZDIR (bkz. SKILL.md kural 3 — global referans dosya öneki ile: `03/İLKE-01`).
- **Yatırım felsefesi (kitap geneli, Kısım 1'den):** Damodaran, DCF'i (içsel değer arayışı), göreli değerlemeyi (piyasanın ortalamada doğru fiyatladığı varsayımı) ve koşullu talep/opsiyon değerlemesini (DCF'in değerleyemediği optionality) BİRBİRİNİ DIŞLAMAYAN, farklı senaryolara uygun ARAÇLAR olarak sunar — "hangisi doğru" değil "hangisi bu varlık için doğru" sorusu merkezdedir. Analist önyargısının (bias), belirsizliğin ve model karmaşıklığının değerlemenin KENDİSİ kadar önemli üç güç olduğunu, "parsimoni ilkesi" (en basit yeterli modeli kullan) ile karmaşıklığın bilinçli sınırlandırılması gerektiğini vurgular; kitabın kapanışı (Ch.18, Kısım 9) bu felsefeyi "Değerlemeyi İyileştirmenin On Adımı" kontrol listesiyle somutlaştırır.
- **Hedef şirket türü / kapsam dışı türler:** Kitap kamuya açık/özel TÜM şirket türlerini kapsar (Kısım 1'de genç/özel şirketler, gelişmekte olan piyasa şirketleri için özel düzeltmeler tanıtıldı — total beta, ülke risk primi/lambda). QuaxisLabs'ın kapsamı (BIST/NASDAQ/Crypto tekil varlık analiz motoru — portföy yönetimi YAPMAZ) ile büyük ölçüde örtüşüyor; kitaptaki M&A/kontrol primi/APV gibi kurumsal-finans-özel konular (Kısım 7-8a, Ch.13/15) büyük ölçüde kapsam dışı çıktı.
- **OCR kalite notu:** Bu PDF'te OCR YOK (metin katmanı var), bu yüzden Graham/Buffett kitaplarındaki OCR hata riski BURADA YOKTUR. Ancak kitaptaki formüller genellikle görsel/denklem olarak gömülü (LaTeX benzeri render) ve düz metin çıkarımında KAYBOLUYOR (`get_text()` formülün YERİNE boşluk/hiçbir şey bırakıyor, sadece formülü ÇEVRELEYEN metin ve değişken tanımları okunabiliyor) — bu yüzden formüllerin çoğu, kitaptaki DEĞİŞKEN TANIMLARI ve SONRAKİ SAYISAL ÖRNEKLERDEN (Illustration'lar) TERS MÜHENDİSLİKLE yeniden inşa edildi, kitaptaki orijinal denklem gösteriminin BİREBİR KOPYASI DEĞİLDİR (telif kuralına zaten uygun — fikir kendi cümleleriyle damıtılıyor).

### Bölüm bazlı durum (TÜMÜ TAMAMLANDI)

| Kısım | Bölümler | PDF sayfa | İLKE | FORMÜL | Eşik satırı | Kontrol maddesi | BAYRAK |
|---|---|---|---|---|---|---|---|
| **Kısım 1** | Ch.1 Introduction to Valuation + Ch.2 Estimating Discount Rates | s.15-117 | 01-57 (57) | 01-24 (24) | 15 + Tablo 2.4 (15) | 13 (A/B/C) | 01-07 (7) |
| **Kısım 2** | Ch.3 Measuring Cash Flows + Ch.4 Forecasting Cash Flows | s.118-217 | 58-98 (41) | 25-51 (27) | 15 | 8 (D-K) | 08-13 (6) |
| **Kısım 3** | Ch.5 Equity DCF Models + Ch.6 Firm Valuation Models | s.218-305 | 99-144 (46) | 52-72 (21) | 12 + Tablo 6.2 (14) | 5 (L-P) | 14-18 (5) |
| **Kısım 4** | Ch.7 Relative Valuation: First Principles + Ch.8 Equity Multiples | s.306-385 | 145-186 (42) | 73-87 (15) | 25 | 4 (Q-T) | 19-27 (9) |
| **Kısım 5** | Ch.9 Value Multiples + Ch.10 Cash/Cross Holdings/Other Assets (+App.10.1) | s.386-477 | 187-236 (50) | 88-104 (17) | 26 | 4 (U-X) | 28-34 (7) |
| **Kısım 6** | Ch.11 Employee Equity Options + Ch.12 Value of Intangibles (+App.12.1) | s.478-590 | 237-284 (48) | 105-123 (19) | 25 | 4 (Y-BB) | 35-41 (7) |
| **Kısım 7** | Ch.13 Value of Control + Ch.14 Value of Liquidity | s.591-705 | 285-341 (57) | 124-137 (14) | 44 | 4 (CC-FF, 20) | 42-53 (12) |
| **Kısım 8a** | Ch.15 The Value of Synergy | s.706-748 | 342-374 (33) | 138-151 (14) | 21 | 17 (GG:7+HH:10) | 54-62 (9) |
| **Kısım 8b** | Ch.16 The Value of Transparency (+App.16.1, 16.2) | s.749-795 | 375-407 (33) | 152-159 (8) | 12 | 18 (II:9+JJ:4+KK:5) | 63-71 (9) |
| **Kısım 9** | Ch.17 The Cost of Distress + Ch.18 Closing Thoughts | s.796-864 | 408-469 (62) | 160-178 (19) | 41 (19 + Tablo 17.1: 15 + Tablo 18.1: 7) | 28 (LL:10+MM:8+NN:10) | 72-83 (12) |

### Kitap geneli TOPLAM sayılar (Kısım 1-9, TÜMÜ TAMAMLANDI — script ile grep doğrulandı)
- İLKE: **469** (İLKE-01…469, kesintisiz, tekrarsız)
- FORMÜL: **178** (FORMÜL-01…178, kesintisiz, tekrarsız)
- EŞİK tablosu satırı: **272** (script ile doğrulandı — tüm "Eşikler" başlıklı 10 bölümdeki 14 ayrı tablo bloğunun TOPLAM veri satırı; 4 ek illüstrasyon/referans tablosunu İÇERİR: Tablo 2.4 kredi notu bandı 15 satır, Tablo 6.2 kredi notu/temerrüt oranı 14 satır, Tablo 17.1 kredi notu/temerrüt olasılığı 15 satır, Tablo 18.1 sektör-çarpan eşlemesi 7 satır)
- KONTROL LİSTESİ maddesi: **186** (script ile doğrulandı — A'dan NN'ye 40 liste, 175 numaralı madde + 11 madde-işaretli/DAHİL-HARİÇ tipi liste öğesi [C/M/N/T listeleri])
...
## Kısım 9 — Bölüm 17-18: Mali Sıkıntı Maliyeti + Kapanış Düşünceleri (Ch.17 The Cost of Distress + Ch.18 Closing Thoughts, PDF s.796-864)

### İlkeler

- İLKE-408: Standart DCF ve göreli değerleme, firmanın SÜREKLİLİK ARZ EDEN (going concern, potansiyel olarak sonsuz ömürlü) bir varlık olduğunu ÖRTÜK olarak varsayar — değerin büyük kısmı (terminal değer) bu varsayıma dayanır; firma sürekliliğini kaybederse (iflas/tasfiye) terminal değerin ötesindeki TÜM nakit akışları kaybolur, bu risk standart modelde YETERİNCE yansıtılmaz.
- İLKE-409: Mali sıkıntı sanılandan çok daha YAYGINDIR — dar tanımla (resmi iflas başvurusu) nadir görünse de, geniş tanımla (faiz ödemelerinde/sözleşme yükümlülüklerinde zorlanma) çok daha sık görülür; büyük/köklü halka açık şirketler de (Enron, Kmart, Lucent, GM, Delta örnekleri) sıkıntıya düşebilir — "büyük firma = sıkıntı riski yok" varsayımı YANLIŞTIR.
- İLKE-410: Sıkıntıya düşen firmaların YALNIZCA küçük bir kısmı resmi iflas sürecine (Chapter 11) girer; girenlerin de ancak üçte biri bağımsız şirket olarak hayatta kalır, geri kalanı ya satın alınır ya tasfiye edilir — "sıkıntı → iflas → tasfiye" doğrusal bir süreç değildir, farklı çıkış yolları vardır.
- İLKE-411: Mali sıkıntının maliyeti DOĞRUDAN (tasfiye/iflas işlem maliyetleri) ve DOLAYLI (müşteri kaybı, çalışan devir hızı artışı, tedarikçilerin daha sıkı koşul dayatması) olmak üzere ikiye ayrılır — dolaylı maliyetler genelde doğrudan maliyetlerden DAHA BÜYÜKTÜR ve "sıkıntılı algısı"nı kendi kendini gerçekleştiren bir kehanete dönüştürebilir.
- İLKE-412: DCF'te sıkıntının göz ardı edilmesinin savunulabilir olduğu 3 KOŞUL: (1) iflas olasılığı yok denecek kadar düşük (büyüklük/devlet garantisi), (2) sermaye piyasalarına kolay erişim iyi yatırımlı firmaların asla zorunlu tasfiyeye düşmemesini sağlıyor, (3) beklenen nakit akışları zaten sıkıntı olasılığını İÇERİYOR VE iskonto oranı sıkıntı riskine göre ayarlanmış VE tasfiye değeri sürekli-firma nakit akışlarının bugünkü değerine EŞİT varsayılıyor. Bu koşullardan biri bile sağlanmıyorsa, standart DCF firma değerini FAZLA gösterir.
- İLKE-413: İskonto oranını sıkıntı riski için yükseltmek YALNIZCA KISMİ bir düzeltmedir — firma yine de sonsuza kadar nakit akışı üretiyormuş gibi (daha düşük bugünkü değerle) modellenir; sıkıntının EN BÜYÜK riski (TÜM gelecek nakit akışlarının kaybı) bu şekilde YETERİNCE yakalanamaz, değerin büyük kısmı yine terminal değerden gelmeye devam eder.
- İLKE-414: Beklenen nakit akışını sıkıntı için düzeltmek, RİSK AYARLAMASI değildir — bu sadece nakit akışının OLMASI GEREKTİĞİ GİBİ (tüm senaryoların olasılık-ağırlıklı ortalaması) doğru tahmin edilmesidir; gerçek bir risk ayarlaması (kesinlik eşdeğeri) yapılacaksa iskonto oranı risksiz orana ÇEKİLMELİDİR — riskli iskonto oranıyla ZATEN düşürülmüş nakit akışını BİR DE risksiz oranla iskontolamak ÇİFTE SAYIMDIR.
- İLKE-415: Sıkıntı olasılığını nakit akışına yansıtmanın pratik zorluğu — sadece HER YIL İÇİN sıkıntı olasılığı değil, YIL BOYUNCA KÜMÜLATİF hayatta kalma olasılığı da izlenmelidir (bir firma 3. yılda sıkıntıya düşerse sadece o yılın değil, SONRAKİ TÜM yılların nakit akışını kaybeder).
- İLKE-416: Simülasyon yaklaşımı, tek bir "beklenen" girdi kullanmak yerine kritik değişkenlerin (gelir büyümesi, faaliyet marjı gibi) TÜM olasılık dağılımını kullanarak sıkıntıyı AÇIKÇA modellemeye imkan tanır; ancak bu yaklaşımın kalitesi TAMAMEN doğru dağılım/parametre seçimine bağlıdır — dikkatsiz/rastgele seçilen dağılımlar etkileyici görünen ama İÇİ BOŞ bir çıktı üretir.
- İLKE-417: Sıkıntılı firmalar için REGRESYON BETASI gerçek riski OLDUĞUNDAN DÜŞÜK gösterir — beta genelde 2-5 yıllık geçmiş fiyat verisiyle tahmin edilir, ama sıkıntı genelde ÇOK DAHA KISA bir dönemde ortaya çıkar; ölçüm penceresinin çoğu firma henüz "sağlıklı" görünürken geçtiği için beta gerçek riskin GERİSİNDE kalır (Enron örneği: 2001 sonu beta tahmini 1,45 — çöküşün büyük kısmı bu pencerenin SONUNDA gerçekleşti).
- İLKE-418: Sıkıntılı firma tahvillerinin VADEYE KADAR GETİRİSİ (YTM), borcun maliyeti olarak KULLANILAMAZ — YTM VAADEDİLEN nakit akışlarına (kupon+anapara) dayanır, oysa yüksek temerrüt olasılığında BEKLENEN nakit akışları vaat edilenden ÇOK DAHA DÜŞÜKTÜR; YTM'yi doğrudan kullanmak borç maliyetini AŞIRI ŞİŞİRİR.
- İLKE-419: Sıkıntılı firmalar için özkaynak maliyeti tahmininde iki alternatif: (1) regresyon betası yerine GÜNCEL piyasa değerli borç/özkaynak oranıyla hesaplanan aşağıdan-yukarı (bottom-up) beta kullanmak — sıkıntılı firmalar genelde düşen hisse fiyatı nedeniyle YÜKSEK D/E oranına sahiptir, bu da kaldıraçlı betayı YÜKSELTİR; ayrıca vergi avantajının kaybolması (faaliyet zararı nedeniyle) betayı DAHA DA yükseltir. (2) Ayrı bir "sıkıntı faktörü" eklemek (tartışmalı — düşük PD/DD hisselerin yüksek getirisinin sıkıntı priminden mi geldiği akademik literatürde ÇELİŞKİLİDİR).
- İLKE-420: Sıkıntılı firma için borç maliyeti, kredi notuna dayalı faiz oranıyla tahmin edilmelidir (YTM yerine) — bu da hâlâ yüksek bir oran verir ama temerrüdün "kaçınılmaz" varsayıldığı YTM'den DAHA MAKUL bir tahmindir.
- İLKE-421: Sermaye maliyeti hesaplamasında, sıkıntılı firma için BAŞLANGIÇ yılında GÜNCEL (yüksek) piyasa değerli borç oranı kullanılmalı, hedef/sektör-ortalama borç oranı KULLANILMAMALIDIR — aşırı kaldıraçlı firmalar için sabit hedef-oran varsayımı ÇOK İYİMSER/YANILTICI değer tahminine yol açar; borç oranı zamanla (iyileşme varsayımıyla) kademeli olarak makul seviyeye ÇEKİLMELİDİR.
- İLKE-422: Sıkıntıyı DCF'e dahil etmenin iki temel YOLU vardır: (A) Modifiye DCF — sürekli-firma ve sıkıntı senaryolarının nakit akışlarını TEK bir beklenen nakit akışında harmanlamak; (B) Ayrı Değerleme — sürekli-firma değerini ve sıkıntı satış değerini AYRI hesaplayıp olasılık-ağırlıklı ortalamasını almak; (B) daha basit VE tutarlı varsayım yönetimine izin verdiği için genelde TERCİH edilir.
- İLKE-423: "Sürekli Firma DCF"(Going Concern DCF), yalnızca firmanın HAYATTA KALDIĞI senaryoları dikkate alır — bu yüzden beklenen nakit akışı, modifiye DCF'teki (sıkıntı senaryosunu da içeren) beklenen nakit akışından DAHA YÜKSEK olur; borç oranının zamanla İYİLEŞECEĞİ ve vergi avantajlarının GERİ GELECEĞİ varsayılır. Uygulamada görülen DCF değerlemelerinin ÇOĞU, etiketlenmese de, aslında bir "sürekli firma" değerlemesidir.
- İLKE-424: Basit ama daha az hassas bir alternatif, sıkıntılı firmayı SAĞLIKLI bir firmaymış GİBİ (sektör ortalaması faaliyet marjı ve sermaye maliyetiyle) değerlemektir — bu yaklaşımın TEHLİKESİ, sağlığa dönüşün hem ACISIZ hem de YAKIN OLDUĞUNU varsaymasıdır, bu da değeri SİSTEMATİK OLARAK ŞİŞİRİR.
- İLKE-425: Sıkıntı olasılığını tahmin etmenin 3 YÖNTEMİ vardır: (1) İSTATİSTİKSEL yaklaşım (geçmiş iflas eden/etmeyen firmaları gözlemlenebilir özelliklere göre ayırt eden model — Z-Score/probit), (2) KREDİ NOTU BAZLI yaklaşım (notlandırılmış tahvillerin tarihsel temerrüt deneyimi), (3) TAHVİL FİYATI BAZLI yaklaşım (piyasa fiyatından zımni temerrüt olasılığını geri çıkarma).
- İLKE-426: Altman Z-Score (1968) doğrusal ayrım analiziyle 5 finansal orandan bir iflas skoru üretir; bu skor sıralama/tahmin gücüne sahiptir ama DOĞRUDAN bir OLASILIK vermez — olasılık için probit/logit gibi bir yöntem (0/1 gösterge değişkeni + finansal oranlarla regresyon) gerekir.
- İLKE-427: İstatistiksel yaklaşımın avantajı, önemli borcu OLMAYAN genç/teknoloji firmaları için de genişletilebilmesidir — bu firmalarda sıkıntı riski "nakit yakma oranı" (cash burn ratio) gibi göstergelerle ilişkilendirilebilir.
- İLKE-428: Kredi notu bazlı yaklaşımın 3 SINIRLILIĞI: (1) temerrüt tahmini sorumluluğu tamamen derecelendirme kuruluşuna devredilir (onların doğru yaptığı varsayılır), (2) derecelendirme standartlarının zaman içinde SABİT kaldığı varsayılır, (3) tablo TAHVİL temerrüdünü ölçer ama firmanın FAALİYETE DEVAM edip etmediğini göstermez — birçok firma temerrütten sonra da sürekli-firma olarak faaliyete devam eder.
- İLKE-429: Tahvil fiyatı bazlı yaklaşım, VAAT EDİLEN nakit akışları yerine BEKLENEN nakit akışlarının risksiz oranla iskontolanmasıyla tahvil fiyatının açıklanabileceği varsayımına dayanır — sabit yıllık temerrüt olasılığı varsayılarak, piyasa fiyatından bu olasılık GERİ ÇIKARILIR (çözülür).
- İLKE-430: Tahvil fiyatı bazlı yaklaşımın SINIRLILIKLARI: (1) dönüştürülebilirlik gibi özel özellikleri OLMAYAN, halka açık fiyatlanmış DÜZ (straight) bir tahvil gerekir — özel yerleştirme tahvillerinde uygulanamaz; (2) aynı firmanın farklı tahvilleri farklı olasılık tahminleri verebilir (sabit-olasılık varsayımı veya fiyatlama hatalarından); (3) kısmi ödeme senaryoları göz ardı edilirse olasılık OLDUĞUNDAN YÜKSEK tahmin edilir.
- İLKE-431: Sıkıntı satış değerini (distress sale proceeds) tahmin etmenin 3 YOLU: (1) DCF değerinin bir YÜZDESİ (%100'den az) olarak varsaymak, (2) SADECE mevcut yatırımların (büyüme varlıkları HARİÇ) sürekli değerini (büyümesiz perpetuity) sıkıntı değeri olarak almak, (3) diğer sıkıntılı firmaların deneyimine dayanarak DEFTER DEĞERİNİN bir yüzdesi olarak tahmin etmek (en PRATİK yöntem).
- İLKE-432: Sürekli-firma değeri ile sıkıntı satış değeri arasındaki FARK, iflas maliyetinin (bankruptcy cost) bir ölçüsü olarak kullanılabilir — Düzeltilmiş Bugünkü Değer (APV) yaklaşımının 3. adımının TEMEL girdisidir.
- İLKE-433: APV yaklaşımının avantajı, borcun değer ETKİSİNİ (vergi avantajı EKSİ iflas maliyeti) firmanın FAALİYET DEĞERİNDEN AYRI hesaplamasıdır — bu, sıkıntı olasılığı ve maliyetine DAHA FAZLA dikkat verilmesini sağlar; sıkıntılı firmalarda vergi avantajı DÜŞÜK (faaliyet zararı nedeniyle) ve iflas maliyeti BÜYÜK olduğundan, bu iki etkinin BİRLEŞİMİ firma değerini önemli ölçüde AZALTIR.
- İLKE-434: Almeida & Philippon (2005) argümanı — geleneksel APV iflas maliyeti tahmini, sıkıntı maliyetlerinin SİSTEMATİK (piyasa/ekonomi kaynaklı) riskini hesaba katmadığı için maliyeti OLDUĞUNDAN DÜŞÜK gösterir; sistematik riske göre düzeltilmiş tahminler beklenen iflas maliyetinin DAHA BÜYÜK ve değeri DAHA FAZLA etkileyen bir unsur olduğunu gösterir.
- İLKE-435: Göreli değerlemede sıkıntı genelde AÇIKÇA değil, İKİ ÖZEL şekilde ele alınır: (1) sıkıntılı firmalarda F/K ve PD/DD çoğu zaman hesaplanamadığı (negatif kazanç/özkaynak) için analistler gelir tablosunda YUKARI çıkıp FD/FAVÖK veya FD/Satış gibi çarpanlara yönelir; bazı firmalarda FAVÖK bile negatiftir, tek pozitif çarpan Satış bazlı olur. (2) analistler sıkıntıyı ÖZNEL olarak hesaba katıp sektör ortalamasına göre iskontolu bir firmayı "hâlâ ucuz değil" diye değerlendirebilir — bu ÖZNEL ayarlama TEHLİKELİDİR çünkü analistler önyargılarını haklı çıkaracak bir yol her zaman bulabilir.
- İLKE-436: Göreli değerlemeyi sıkıntıya uyarlamanın 2 YOLU: (1) sıkıntılı firmayı DİĞER SIKINTILI firmalarla (aynı sektörden veya tüm piyasadan) karşılaştırmak — ancak yalnızca sektörde ÇOK SAYIDA firma aynı anda sıkıntılıysa işe yarar ve farklı derecede sıkıntılı firmaları AYNI KEFEYE koyma riski taşır; (2) SAĞLIKLI emsal firmaların çarpanını kullanıp, kredi notu SINIFINA göre gözlemlenen çarpan farklarını (piyasanın zaten uyguladığı iskonto) OBJEKTİF bir ayarlama olarak kullanmak.
- İLKE-437: Sıkıntıyı göreli değerlemeye AÇIKÇA dahil etmenin en tutarlı yolu, sağlıklı emsal çarpanıyla hesaplanan "sürekli firma" değerini, DCF'teki gibi hayatta kalma/sıkıntı olasılıklarıyla AĞIRLIKLANDIRMAKTIR — bu, sektörün büyük çoğunluğu SAĞLIKLI olan ama TEK bir firmanın sıkıntılı olduğu durumlar için EN UYGUN yaklaşımdır.
- İLKE-438: Sıkıntılı firmalarda firma değerinden özkaynak değerine geçişte 2 ÖZEL sorun ortaya çıkar: (1) DEĞİŞKEN BORÇ YÜKÜ — bu firmalar sık sık borç yeniden yapılandırması/müzakeresi içindedir, borcun GÜNCEL piyasa değerini (defter değeri DEĞİL) tespit etmek zordur ve gün be gün değişebilir; (2) OPSİYON KARAKTERİ — özkaynak, sınırlı sorumluluk nedeniyle DCF'in ima ettiğinden DAHA YÜKSEK bir primle işlem görebilir.
- İLKE-439: Sıkıntılı firma borcunu değerlerken: (a) son mali tablo yerine GÜNCEL borç tutarı araştırılmalı, (b) borcun piyasa değeri SIK sık güncellenmeli (defter değeri ASLA piyasa değeri proxy'si olarak kullanılmamalı — borcu bir kurumsal tahvil gibi değerle), (c) dönüştürülebilir borç, "düz borç" kısmı + dönüştürme opsiyonu (özkaynak olarak) diye AYRIŞTIRILMALIDIR.
- İLKE-440: Bir bütün olarak sıkıntılı firmayı değerlemek, o firmanın ÖZKAYNAĞINI değerlemekten ÇOK DAHA KOLAYDIR — çünkü borç tutarı zamanla önemli ölçüde DEĞİŞİR, firma değeri daha İSTİKRARLI bir hedeftir.
- İLKE-441: Özkaynak, tasfiye ETME OPSİYONU + SINIRLI SORUMLULUK kombinasyonu nedeniyle firma üzerinde bir CALL OPSİYONU özelliği taşır — dayanak varlık firmanın kendisi, kullanım fiyatı borcun itfa (yüz) değeri, vade ise borcun ödeme tarihidir; özkaynak sahipleri firma varlıklarının değerinden borcu ödeyip GERİ KALANI alma HAKKINA sahiptir, ama borç değeri varlık değerini AŞARSa yatırımlarından FAZLASINI ödemek ZORUNDA DEĞİLDİRLER.
- İLKE-442: Standart DCF'te firma değeri borç yüz değerinin ALTINA düşerse özkaynak DEĞERSİZDİR; opsiyon çerçevesinde ise özkaynak, firma değeri borç yüz değerinin (hatta çok daha aşağısının) altına düşse bile DEĞER TAŞIMAYA DEVAM eder — bu, derin para-dışı (deep out-of-the-money) bir alım opsiyonunun ZAMAN PRİMİ nedeniyle hâlâ değer taşımasıyla AYNI mantık: borç vadesine kadar varlık değerinin toparlanma İHTİMALİ.
- İLKE-443: Standart DCF'te risk artışı neredeyse HER ZAMAN özkaynak değerini DÜŞÜRÜR; ancak özkaynak bir opsiyon özelliği taşıdığında bu ilişki TERSİNE dönebilir — derin sıkıntılı bir firmada, kaybedilecek çok az, kazanılacak çok fazla şey olduğundan, artan varlık DEĞER OYNAKLIĞI özkaynak değerini YÜKSELTİR (risk, sıkıntılı özkaynak sahibi için MÜTTEFİK haline gelir).
- İLKE-444: Black-Scholes/opsiyon fiyatlama çerçevesinden çıkan N(d2), varlık değerinin borç yüz değerini AŞMA (risk-nötr) olasılığıdır; [1−N(d2)] ise RİSK-NÖTR temerrüt olasılığıdır — bu çerçeve, aynı zamanda borç için uygun temerrüt marjının (default spread) türetilmesine de imkan tanır; bankacılık/kredi portföylerinde temerrüt olasılığı VE talep edilen faizin yeterliliğini test etmek için kullanılabilir.
- İLKE-445: Özkaynağı opsiyon olarak değerleme modelinin 4 BASİTLEŞTİRİCİ varsayımı: (1) firmada sadece iki hak sahibi vardır (borç ve özkaynak — imtiyazlı hisse gibi ek talep sahipleri modeli zorlaştırır), (2) TEK bir borç ihracı vardır ve YÜZ değerinden geri ödenebilir, (3) borç sıfır kuponludur ve dönüştürülebilirlik gibi özel özellikler taşımaz, (4) firma değeri ve bu değerin oynaklığı TAHMİN EDİLEBİLİR — kupon ödemeli/çok-tranşlı gerçek borç yapıları bu varsayımları ZORLAR (kupon tarihlerinde nakit yetersizse özkaynak sahipleri erken "kullanım"a zorlanabilir).
- İLKE-446: Firma değerini opsiyon modeline girdi olarak tahmin etmenin 4 YOLU: (1) piyasa değerli borç+özkaynağı toplamak (İÇSEL TUTARSIZ — aynı piyasa değerlerinden yola çıkıp opsiyon modeliyle FARKLI değerlere ulaşılır), (2) beklenen nakit akışlarını sermaye maliyetiyle iskontolayarak DCF değeri kullanmak (mevcut yatırımlarla sınırlı tutulmalı, ama sıkıntı faaliyet gelirini etkilediğinden bu değer DÜŞÜK çıkabilir), (3) sağlıklı emsal firmaların gelir çarpanını uygulamak, (4) ayrıştırılabilir/ayrı işlem gören varlıkların piyasa değerlerini toplamak (örn. gayrimenkul portföyünün her mülkü ayrı değerlenip toplanır).
- İLKE-447: Firma değeri oynaklığını doğrudan (hisse + tahvil oynaklığı ve korelasyonundan) tahmin etmek MÜMKÜNDÜR ama firma sıkıntıya girdikçe hem hisse hem tahvil fiyatları AŞIRI oynak hale geldiğinden bu YANILTICI sonuçlar verebilir; bu durumda SEKTÖRDEKİ diğer (traded) firmaların ORTALAMA firma-değeri oynaklığını kullanmak daha GÜVENİLİR sonuç verir.
- İLKE-448: Çok tranşlı/kupon ödemeli gerçek borç yapısını TEK bir eşdeğer sıfır-kupon borca dönüştürmek için 2 YAKLAŞIM: (1) her borç ihracının SÜRESİNİ (duration) hesaplayıp yüz-değeri-ağırlıklı ortalamasını almak (kupon+vade ikisini de hesaba katar), (2) daha kaba bir yaklaşım olarak yüz-değeri-ağırlıklı ORTALAMA VADEYİ doğrudan kullanmak.
- İLKE-449: Çoklu borç ihracı olan bir firmada "borcun yüz değeri" girdisi için 3 SEÇENEK: (1) sadece anapara toplamı (kupon ödemelerini göz ardı ettiği için borcu OLDUĞUNDAN DÜŞÜK gösterir), (2) anapara + tüm gelecek faiz/kupon ödemelerinin toplamı (farklı zaman noktalarındaki nakit akışlarını KARIŞTIRIR ama en BASİT yöntemdir), (3) sadece anapara + yıllık faiz ödemelerini opsiyon modelindeki TEMETTÜ GETİRİSİ gibi ele almak (her yıl firma değerinden beklenen ödeme kadar bir "sızıntı" varsayılır).
- İLKE-450: Değerleme modeli sayısı sorun DEĞİLDİR (aksine ÇOK FAZLA model vardır) — asıl sorun DOĞRU modeli seçmektir; bir varlığı önceden belirlenmiş bir modele UYDURMAYA çalışmak (tam tersi gerekirken) zaman/kaynak kaybıdır ve YANLIŞ değere yol açar.
- İLKE-451: Dört temel değerleme ailesi (varlık-bazlı, indirgenmiş nakit akışı, göreli değerleme, opsiyon fiyatlama), her biri farklı bir PİYASA VARSAYIMI taşır — DCF fiyatların uzun vadede içsel değere yakınsadığını, göreli değerleme piyasanın ORTALAMADA doğru fiyatladığını (bireysel firmalar yanlış olsa da sektör/piyasa geneli doğru), varlık-bazlı gerçek/finansal varlık piyasaları arasındaki SAPMALARDAN yararlanılabileceğini, opsiyon fiyatlama ise piyasanın ESNEKLİĞİ (optionality) doğru fiyatlayamadığını varsayar.
- İLKE-452: Varlık pazarlanabilirliği model seçimini belirler — ayrılabilir/bağımsız satılabilir varlıklara sahip firmalarda (gayrimenkul, kapalı-uçlu yatırım fonu) tasfiye/yenileme-maliyeti değerlemesi UYGULANABİLİR; marka değeri gibi AYRILAMAZ maddi olmayan varlıklara dayalı firmalarda (tüketici ürünleri) bu yaklaşımlar İŞLEMEZ.
- İLKE-453: Varlıklar nakit akışı üretme KAPASİTESİNE göre 3 gruba ayrılır: (1) halihazırda/yakın gelecekte nakit akışı üreten varlıklar (çoğu halka açık şirket — negatif nakit akışlı genç şirketler DAHİL — DCF ile değerlenir), (2) KOŞULLU nakit akışı üretebilecek varlıklar (ilaç patenti, gelişmemiş doğal kaynak rezervi — OLASILIK atayıp DCF ile değerlemek değeri DÜŞÜK gösterir, OPSİYON FİYATLAMA modeli kullanılmalıdır), (3) HİÇBİR ZAMAN nakit akışı üretmeyecek varlıklar (birincil konut, koleksiyon, sanat eseri — SADECE göreli değerleme ile değerlenebilir).
- İLKE-454: Emsal bulunabilirliği (biriciklik) bir spektrumdur — çok sayıda benzer varlığın bulunduğu durumda göreli değerleme GÜVENİLİRDİR; gerçekten BİRİCİK firmalar/varlıklar için DCF DAHA İYİ tahmin verir.
- İLKE-455: Analist zaman ufku model seçimini etkiler — DCF sonsuz ufuklu sürekli-firma varsayımına, tasfiye değeri BUGÜN faaliyeti durdurma varsayımına dayanır; göreli ve opsiyon değerleme İKİSİ ARASINDA bir konumdadır; uzun ufuklu değerlemeler (M&A gibi) DCF'e, kısa ufuklu değerlemeler (portföy yönetimi/hisse araştırması gibi) göreli değerlemeye YATKINDIR.
- İLKE-456: Değerlemenin AMACI model seçimini belirler — sektör analistleri (göreceli olarak ucuz/pahalıyı bulmakla görevli, performansı emsal analistlere göre değerlendirilen) çarpanları TERCİH eder; bireysel yatırımcı/özel işletme alıcısı gibi İÇSEL değeri arayanlar DCF'i TERCİH eder.
- İLKE-457: Her yaklaşımın örtük bir piyasa-verimliliği inancı vardır — nihayetinde HEPSİ, piyasanın kendi hatasını ZAMANLA düzelteceğini varsayar; farklı olan sadece hangi TÜR yanlış fiyatlamanın (bireysel firma vs sektör vs piyasa, gerçek vs finansal varlık, esneklik) düzeltileceği inancıdır.
- İLKE-458: Özkaynak veya firma yaklaşımı (kaldıraç sabit varsayımında) TUTARLI varsayımlarla AYNI değeri vermelidir — kaldıraç DEĞİŞKEN/hedefe doğru hareket ediyorsa firma yaklaşımı DAHA BASİTTİR (özkaynak yaklaşımı faiz/anapara ödemesi projeksiyonu gerektirir ve kaldıraç hatalarına ÇOK DUYARLIDIR); dolar bazlı borç varsayımı tercih ediliyorsa APV yaklaşımına geçilebilir.
- İLKE-459: Temettü İskonto Modeli (DDM) SADECE 2 durumda TERCİH edilmelidir: (1) borç/yeniden-yatırım tanımı belirsiz/çelişkili olduğu için nakit akışları hassasiyetle TAHMİN EDİLEMİYORSA (finansal kuruluşlar için tipik gerekçe), (2) hisse geri alımı gibi nakit iadesi biçimlerine YÖNETİM ÜZERİNDE kontrolün olmadığı SIKI kısıtlamalar varsa (bu durumda beklenebilecek TEK nakit akışı temettüdür); TÜM diğer durumlarda FCFE, temettüden farklı (yüksek ya da düşük) olsa bile DAHA GERÇEKÇİ bir değer verir.
- İLKE-460: Güncel kazançlar yerine NORMALLEŞTİRİLMİŞ kazanç KULLANILMASI, ancak negatif/anormal kazancın GEÇİCİ olduğu durumlarda (döngüsel düşüş, olağanüstü tek seferlik gider, yeniden yapılanma dönemi) UYGUNDUR — bu durumlarda kazancın kısa sürede normale döneceği varsayılır.
- İLKE-461: Negatif/düşük kazancın UZUN VADELİ bir olgu olduğu 3 firma grubu VARDIR ve bunlarda normalleştirme YANLIŞ değer verir: (1) uzun süreli operasyonel/stratejik/finansal sorunlu firmalar — umutsuz/iflasa yakınsa OPSİYON FİYATLAMA veya TASFİYE DEĞERİ modeli, kurtarılabilirse operasyonel marjları KADEMELİ iyileştirme varsayımıyla DCF gerekir; (2) altyapı firmaları — erken dönemde büyük capex/düşük amortisman nedeniyle negatif nakit akışı NORMALDİR, capex düştükçe/marj iyileştikçe DEĞER OLUŞUR; (3) genç start-up'lar — yüksek gelir büyümesi + zamanla iyileşen marj varsayımı gerekir.
- İLKE-462: Büyüme paterni seçimi, firmanın GÜNCEL büyüme MOMENTUMUNA göre 3 gruba ayrılır: istikrarlı-büyüme (ekonomi nominal büyüme oranında/altında) → sabit-büyüme modeli yeterlidir; orta-büyüme (ekonomi büyümesinden makul ölçüde YÜKSEK, kaba kural: ekonomi büyümesinin %8-10 fazlası bandında) → 2-aşamalı model gerekir; yüksek-büyüme (ekonomiden ÇOK YÜKSEK) → 3-aşamalı/n-aşamalı geçiş modeli gerekir.
- İLKE-463: Büyümenin KAYNAĞI (genel rekabet avantajı — marka/ölçek ekonomisi — vs özel/yasal engel — lisans/patent) büyümenin NASIL sönümleneceğini belirler: yasal engel kaynaklı büyüme genelde ANİDEN düşer (2-aşamalı desen — patent süresi bitince), genel rekabet avantajı kaynaklı büyüme ise rakiplerin girişiyle KADEMELİ olarak erir; erime hızı rekabet avantajının doğasına, yönetim yetkinliğine ve sektöre giriş kolaylığına bağlıdır.
- İLKE-464: Firmayı MEVCUT (status quo) yönetimle mi yoksa OPTİMAL yönetimle mi değerlemek gerektiği yatırımcının POZİSYONUNA bağlıdır — devralıp yönetimi değiştirmeyi planlayan alıcı optimal-yönetim değerini kullanmalı; küçük yatırımcı, güçlü kurumsal yönetişim mekanizmaları (düşmanca devralma tehdidi, hızlı yönetici değişimi) varsa optimal değere yakınsamayı bekleyebilir, yoksa mevcut yönetim varsayımıyla değerlemelidir; kurumsal yatırımcı bu iki uç arasında, değişimi TEŞVİK EDEBİLME potansiyeliyle konumlanır.
- İLKE-465: Hangi çarpanın kullanılacağına karar vermenin 3 YOLU: (1) "sinik" yaklaşım — hikayeye en uygun çarpanı seçmek (manipülasyona kayar, kullanıcı bu riske karşı HANGİ çarpan/emsal grubu seçildiğini SORGULAMALIDIR), (2) "balyoz" yaklaşım — bir düzine çarpanı birden kullanıp aralık/ortalama/ağırlıklı-ortalama ile birleştirmek (aralık genelde KULLANIŞSIZ kadar geniş çıkar), (3) "en iyi çarpan" yaklaşımı — temel (fundamentals) ilişkisi, istatistiksel (regresyon R²) veya geleneksel (sektörde yerleşik) kritere göre TEK bir en uygun çarpanı seçmek.
- İLKE-466: İdeal durumda üç "en iyi çarpan" kriteri (temel ilişki, istatistiksel R², sektör geleneği) BİRBİRİYLE ÖRTÜŞMELİDİR; sektörde YERLEŞİK çarpan artık temel değerleri YANSITMIYORSA (sektör geçiş/dönüşüm halindeyse) bu üçü AYRIŞIR ve yanıltıcı değer tahminine yol açar.
- İLKE-467: Emsal grubu tanımı DAR (aynı sektör + benzer büyüklük/pazar) veya GENİŞ (tüm sektör/piyasa) seçilebilir — farkları SÜBJEKTİF olarak kontrol edecekseniz DAR grup, İSTATİSTİKSEL (regresyon) olarak kontrol edecekseniz GENİŞ grup tercih edilmelidir; sektör-bazlı ve piyasa-geneli göreli değerleme FARKLI sorulara cevap verir (sektöre göre mi, piyasaya göre mi ucuz/pahalı) ve BİRBİRİYLE ÇELİŞEBİLİR.
- İLKE-468: Bir firma AYNI ANDA DCF'e göre PAHALI ama göreli değerlemeye göre UCUZ (ya da tersi) çıkabilir — bu, İLGİLİ SEKTÖRÜN kendisinin yanlış fiyatlandığının GÖSTERGESİDİR (Amazon örneği: Mart 2000'de DCF'e göre pahalı ama dot-com emsallerine göre ucuz; Mart 2001'de DCF'e göre ucuz ama emsallere göre pahalı); ideal yatırım fırsatı HER İKİ yönteme göre de UCUZ çıkan firmalardır.
- İLKE-469: Opsiyon fiyatlama modellerinin kullanımı için 3 GENEL kural: (1) TASARRUFLU kullan — opsiyonlar değeri en çok, değerinin büyük kısmını opsiyon-benzeri varlıklardan alan KÜÇÜK firmalarda etkiler (küçük biyoteknoloji firması için patent-opsiyonu değerlemesi mantıklıdır, geliştirilmiş ilaç portföyünden değer üreten büyük bir ilaç devi için DEĞİL); (2) fırsat HER ZAMAN opsiyon DEĞİLDİR — bir fırsatın değerli bir opsiyona dönüşmesi için REKABETE KARŞI dışlayıcılık (yasal kısıtlama veya belirgin rekabet avantajı) gerekir; (3) opsiyonları ÇİFTE SAYMA — eğer DCF'teki büyüme oranı zaten firmanın gelişmemiş varlıklarını (örn. petrol rezervlerini) yansıtacak şekilde YÜKSEK belirlendiyse, bu varlıkları AYRICA opsiyon değeri olarak eklemek ÇİFTE SAYIMDIR.

### Formüller

- FORMÜL-160: Sıkıntı-Ayarlı Beklenen Nakit Akışı (Modifiye DCF)
  - Formül: `E(Nakit_Akışı_t) = π_Sürekli,t × Nakit_Akışı_Sürekli,t + (1 − π_Sürekli,t) × Nakit_Akışı_Sıkıntı,t`
  - Değişkenler: π_Sürekli,t = t dönemine kadar firmanın sürekli-firma olarak kalma KÜMÜLATİF olasılığı; Nakit_Akışı_Sürekli,t = sürekli-firma senaryosunda beklenen nakit akışı; Nakit_Akışı_Sıkıntı,t = sıkıntı senaryosunda (genelde tasfiye/sıkıntı satışı) elde edilen değer.
  - QuaxisLabs karşılığı: VERİ EKSİK (yapısal) — π_Sürekli (kümülatif sıkıntı olasılığı) hiç hesaplanmıyor; `merton.py::compute_merton_dd_edf()` YAKIN bir kavramsal karşılık (temerrüt olasılığı üretir) ama valuation.py'nin DCF bloğuyla HİÇ BAĞLANTILI DEĞİL (grep ile doğrulandı — `compute_merton_dd_edf` hiçbir dosyada import/çağrılmıyor).
- FORMÜL-161: Kümülatif Sürekli-Firma (Hayatta Kalma) Olasılığı
  - Formül: `π_Sürekli,n = Π_{i=1}^{n} (1 − π_Sıkıntı,i)` — örnek: yıl 1 sıkıntı olasılığı %20, yıl 2 %10 ise 2 yıl kümülatif hayatta kalma = (1−0,20)×(1−0,10) = %72.
  - Değişkenler: π_Sıkıntı,i = i. yıla ÖZGÜ (o yıl İÇİNDE) sıkıntıya düşme olasılığı.
  - QuaxisLabs karşılığı: VERİ EKSİK — yıllık sıkıntı olasılığı serisi yok; Merton EDF (bkz. FORMÜL-160) tek-ufuklu (genelde 1 yıllık) bir anlık kesit sağlar, ÇOK-YILLI kümülatif seri türetmek için EK varsayım gerekir.
- FORMÜL-162: Ayrı Değerleme — Sıkıntı Dahil Firma Değeri
  - Formül: `Değer_Firma = π_Sürekli × Değer_Sürekli-Firma + (1 − π_Sürekli) × Değer_Sıkıntı-Satışı`
  - Değişkenler: Değer_Sürekli-Firma = sadece hayatta-kalma senaryosu varsayımıyla hesaplanan standart DCF değeri; Değer_Sıkıntı-Satışı = tasfiye/acil-satış değeri (bkz. FORMÜL-166); π_Sürekli = ufuk boyunca kümülatif hayatta kalma olasılığı.
  - QuaxisLabs karşılığı: VERİ EKSİK — hem π_Sürekli hem Değer_Sıkıntı-Satışı yok; ancak Değer_Sürekli-Firma'nın KENDİSİ zaten `valuation.py::compute_valuation_assessment()` (Damodaran FCFE bloğu) ile KISMEN mevcut (β=1, WACC yok basitleştirmeleriyle, Kısım 1'den beri bilinen sınırlamalarla).
- FORMÜL-163: Sınırlı Sorumluluk Düzeltmeli Özkaynak Değeri
  - Formül: `Değer_Özkaynak = π_Sürekli × Özkaynak_Sürekli-Firma + (1 − π_Sürekli) × max(0, Değer_Sıkıntı-Satışı − Borç)`
  - Değişkenler: max(0, ...) terimi, sıkıntı satış değeri borcu KARŞILAMADIĞINDA özkaynak sahiplerinin yatırımlarından FAZLASINI kaybetmediğini (sınırlı sorumluluk) yansıtır.
  - QuaxisLabs karşılığı: VERİ EKSİK — FORMÜL-162 ile aynı girdi eksiklikleri; kavramsal olarak `merton.py`'nin call-opsiyonu çerçevesiyle (bkz. FORMÜL-171) AYNI mantığı taşır, ama bu formül YILLIK OLASILIK SERİSİ ister, Merton modeli TEK BİR ufuk anı (T yıl sonra) için opsiyon değeri verir — birbirini TAMAMLAYICI, aynı hesap DEĞİL.
- FORMÜL-164: Nakit Yakma Oranı (Cash Burn Ratio)
  - Formül: `Nakit_Yakma_Oranı = Nakit_Bakiyesi / |FAVÖK|` (FAVÖK negatif iken) — kaç dönemde nakdin tükeneceğinin kaba bir ölçüsü.
  - Değişkenler: Nakit_Bakiyesi = güncel nakit ve nakit benzerleri; FAVÖK = negatif faaliyet karı öncesi amortisman kârı/zararı.
  - QuaxisLabs karşılığı: KISMEN MEVCUT — `cash` alanı ve `calculator.ebitda()` (FAVÖK) ZATEN mevcut (Kısım 1/Buffett bulguları); bu oran SIFIR yeni ham veri gerektirmeden `calculator.Ratios`'a eklenebilir — **en düşük maliyetli somut bulgu, sadece negatif FAVÖK'lü şirketler için anlamlı.**
- FORMÜL-165: APV — Kaldıraçsız Firma Değeri (Sabit Büyüme)
  - Formül: `Değer_Kaldıraçsız = FCFF₀ × (1+g) / (ρ_u − g)`
  - Değişkenler: FCFF₀ = güncel vergi-sonrası faaliyet nakit akışı; ρ_u = kaldıraçsız özkaynak maliyeti (kaldıraçsız beta ile CAPM); g = beklenen büyüme oranı.
  - QuaxisLabs karşılığı: KISMEN MEVCUT (kavramsal) — `valuation.py`'nin Gordon büyüme bloğu YAPISAL OLARAK aynı formül ailesidir, ama KALDIRAÇLI özkaynak maliyeti (β=1 basitleştirmesiyle) kullanır; kaldıraçsız beta hiç hesaplanmıyor (bottom-up beta/sektör kaldıraçsız beta altyapısı YOK — Kısım 1'den beri bilinen açık).
- FORMÜL-166: APV — Vergi Avantajının Bugünkü Değeri (Perpetuite)
  - Formül: `PV(Vergi_Avantajı) = (Vergi_Oranı × Faiz_Gideri) / Borç_Maliyeti`
  - Değişkenler: Vergi_Oranı = marjinal/efektif kurumlar vergisi oranı; Faiz_Gideri = borç üzerindeki yıllık faiz ödemesi; Borç_Maliyeti = vergi öncesi borçlanma maliyeti (iskonto oranı olarak kullanılır, riskin yansıtılması için).
  - QuaxisLabs karşılığı: VERİ EKSİK — `interest_expense` SADECE banka şeması (UFRS) için mevcut (hem `isyatirim.py` hem `kap_financials.py::STANDARD_ITEM_MAP_KAP_UFRS_INCOME`'da), sanayi/ticaret (XI_29) şirketleri için `STANDARD_ITEM_MAP_KAP_XI_29_INCOME`'da grep ile DOĞRULANDI Kİ HÂLÂ YOK — bu açık artık kitap genelinde (Kısım 1/2/3/7) TEKRAR TEKRAR doğrulanan en sık açıktan, KAP_FINANCIALS.PY YENİ FETCHER'INDA BİLE ÇÖZÜLMEMİŞ olarak, 6. kez doğrulandı.
- FORMÜL-167: APV — Beklenen İflas Maliyetinin Bugünkü Değeri
  - Formül: `PV(İflas_Maliyeti) = π_a × BC`, burada `BC ≈ Değer_Sürekli-Firma − Değer_Sıkıntı-Satışı`
  - Değişkenler: π_a = ek borç sonrası temerrüt olasılığı; BC = iflas maliyeti (sürekli-firma değeri ile sıkıntı satış değeri arasındaki fark olarak yaklaşık tahmin edilir).
  - QuaxisLabs karşılığı: VERİ EKSİK — π_a (FORMÜL-160/161 ile aynı açık) ve Değer_Sıkıntı-Satışı yok; Merton EDF (`merton.py`) π_a için EN YAKIN mevcut proxy ama HİÇ BAĞLANMAMIŞ (bkz. BAYRAK-79).
- FORMÜL-168: APV Firma Değeri
  - Formül: `Değer_Firma_APV = Değer_Kaldıraçsız + PV(Vergi_Avantajı) − PV(İflas_Maliyeti)`
  - Değişkenler: bkz. FORMÜL-165/166/167.
  - QuaxisLabs karşılığı: VERİ EKSİK — üç bileşeninin ÜÇÜ DE (kaldıraçsız beta, faiz gideri/XI_29, iflas maliyeti girdileri) eksik olduğundan APV yaklaşımı BAŞTAN SONA uygulanamıyor; bu, Kısım 3'te (Ch.6 Firm Valuation) tespit edilen "WACC/FCFF/APV ailesinin TAMAMI kapsam dışı" bulgusunun Kısım 9'da 2. kez, mali sıkıntı bağlamında DOĞRULANMASI.
- FORMÜL-169: İleri Vadeli Çarpanla Sıkıntı-Ağırlıklı Değerleme
  - Formül: `Değer_Firma = π_Sürekli × [Çarpan_Sağlıklı-Emsal × Gelecek_Yıl_Değişkeni / (1+WACC)^n] + (1−π_Sürekli) × Değer_Sıkıntı-Satışı`
  - Değişkenler: Çarpan_Sağlıklı-Emsal = sağlıklı emsal firmaların ortalama FD/FAVÖK veya benzeri çarpanı; Gelecek_Yıl_Değişkeni = n. yıl tahmini FAVÖK/Satış; WACC = iskonto oranı.
  - QuaxisLabs karşılığı: VERİ EKSİK — WACC yok (kitap genelinde bilinen en yaygın tekil açık), çok-yıllı FAVÖK PROJEKSİYONU altyapısı yok (QuaxisLabs GEÇMİŞ veriyle çalışır, GELECEK tahmini üretmez); sektör emsal çarpanı (FD/FAVÖK ortalaması) ZATEN mevcut (`ev_ebitda`, Kısım 5 bulguları).
- FORMÜL-170: Tahvil Fiyatından Zımni Temerrüt Olasılığı
  - Formül: `Fiyat = Σ_{t=1}^{N} [(1−π)^t × Kupon] / (1+r_f)^t + [(1−π)^N × Anapara] / (1+r_f)^N` (sabit yıllık temerrüt olasılığı π varsayımıyla, kısmi geri kazanım yok varsayımı) — π için deneme-yanılma/çözücü (solver) gerekir.
  - Değişkenler: Fiyat = tahvilin güncel piyasa fiyatı; Kupon = yıllık kupon ödemesi; N = vadeye kalan yıl; r_f = risksiz oran; π = yıllık (sabit varsayılan) temerrüt olasılığı (çözülen bilinmeyen).
  - QuaxisLabs karşılığı: UYGULANAMAZ — QuaxisLabs hiçbir tahvil/kurumsal borç fiyatı çekmiyor (kapsamı hisse senedi/kripto fiyatları); bu yaklaşım BIST/NASDAQ hisse senedi odaklı mimariyle YAPISAL OLARAK uyuşmuyor.
- FORMÜL-171: Özkaynağı Alım Opsiyonu Olarak Değerleme (Black-Scholes/Merton)
  - Formül: `Özkaynak = A × N(d1) − D × e^(−rT) × N(d2)`, `d1 = [ln(A/D) + (r + 0,5σ²)T] / (σ√T)`, `d2 = d1 − σ√T`
  - Değişkenler: A = firma (varlık) değeri; D = borcun yüz değeri (kullanım fiyatı); r = risksiz oran; T = borcun vadesi; σ = varlık değeri oynaklığı.
  - QuaxisLabs karşılığı: **ZATEN MEVCUT (mimari eşleşme)** — `src/analysis/merton.py::compute_merton_dd_edf()` YAPISAL OLARAK AYNI Black-Scholes çerçevesini kullanıyor (Kısım 6'da FORMÜL-121 için de tespit edilen ortak matematiksel çekirdek), ama TERS yönde çalışır: kitap A/σ_A'dan Özkaynak'ı türetirken, `merton.py` GÖZLEMLENEN Özkaynak (piyasa değeri) ve σ_Özkaynak'tan A/σ_A'yı GERİ ÇIKARIR (Vassalou-Xing/KMV standart prosedürü) — matematiksel olarak eşdeğer, pratik yönü TERSİNE çevrilmiş.
- FORMÜL-172: Risk-Nötr Temerrüt Olasılığı ve Temerrüt Marjı
  - Formül: `π_Temerrüt = 1 − N(d2)`; `Borç_Faiz_Oranı = (D / Değer_Borç)^(1/T) − 1` (sıfır kupon borç için); `Temerrüt_Marjı = Borç_Faiz_Oranı − r_f`
  - Değişkenler: N(d2) = bkz. FORMÜL-171; Değer_Borç = Firma_Değeri − Özkaynak_Değeri (opsiyon modelinden çıkan örtük borç değeri).
  - QuaxisLabs karşılığı: **ZATEN MEVCUT** — `MertonResult.default_probability_pct` alanı TAM OLARAK bu formülün ([1−N(d2)], EDF olarak adlandırılan) çıktısıdır (`merton.py` satır 160); temerrüt marjı (default spread) hesaplaması AYRICA yapılmıyor ama `distance_to_default`/`asset_value` alanlarından türetilebilir.
- FORMÜL-173: Firma Değeri Oynaklığı (İki-Varlık Portföy Varyansı Uzantısı)
  - Formül: `σ²_Firma = w_e² × σ_e² + w_d² × σ_d² + 2 × w_e × w_d × ρ_ed × σ_e × σ_d`
  - Değişkenler: w_e/w_d = özkaynak/borcun piyasa-değeri ağırlıkları; σ_e/σ_d = özkaynak/borç fiyatı oynaklığı; ρ_ed = özkaynak-borç fiyat korelasyonu.
  - QuaxisLabs karşılığı: VERİ EKSİK (kısmen) — σ_e (özkaynak oynaklığı) `merton.py::annualized_equity_volatility()` ile ZATEN hesaplanıyor; σ_d (tahvil oynaklığı) ve ρ_ed hiç YOK (tahvil fiyatı verisi yok); `merton.py` bu YÜZDEN doğrudan σ_e'den σ_A'yı iteratif ÇÖZER, bu formülü DOLAYLI olarak baypas eder — mevcut mimari kararı zaten bu veri eksikliğini HESABA KATMIŞ.
- FORMÜL-174: Piyasa Değerli Borç/Sermaye Oranı (Sıkıntı Bağlamında)
  - Formül: `Borç/Sermaye_Piyasa = Borç_Piyasa_Değeri / (Borç_Piyasa_Değeri + Özkaynak_Piyasa_Değeri)`
  - Değişkenler: Borç_Piyasa_Değeri = tahvil/kredi piyasa değeri (defter değeri DEĞİL); Özkaynak_Piyasa_Değeri = piyasa değeri (market_cap).
  - QuaxisLabs karşılığı: KISMEN MEVCUT — `calculator.debt_to_equity` DEFTER değerli borç/özkaynak kullanıyor (Kısım 8b'de FORMÜL-156 notunda da işaretlenen tanım farkı); borcun PİYASA DEĞERİ (tahvil fiyatı/kredi spreadi) hiç hesaplanmıyor — sıkıntılı firmalar için bu fark ÖZELLİKLE büyük olur (defter değeri borcun gerçek risk-ayarlı değerinden ÇOK YÜKSEK kalabilir).
- FORMÜL-175: Sıkıntı-Ayarlı Kaldıraçlı Beta (Vergi Avantajsız)
  - Formül: `β_Kaldıraçlı = β_Kaldıraçsız × [1 + (1 − t) × (D/E)_Piyasa]`, sıkıntılı firmalarda `t → 0` (yakın vadede vergi avantajı beklenmiyorsa)
  - Değişkenler: β_Kaldıraçsız = sektör/iş kolu bazlı kaldıraçsız beta; t = efektif vergi oranı (sıkıntılı firmada genelde SIFIRA yakın varsayılır); (D/E)_Piyasa = GÜNCEL piyasa değerli borç/özkaynak.
  - QuaxisLabs karşılığı: VERİ EKSİK — kaldıraçsız beta/bottom-up beta altyapısı hiç YOK (regresyon betası da yok — pazar endeksi getiri serisi çekilmiyor, Kısım 1'den beri bilinen açık); bu formül İKİNCİ (β eksikliğine ek olarak "vergi avantajsız" ayarlaması) bir katman daha ekliyor.
- FORMÜL-176: Orta-Büyüme Bandı Tanımı
  - Formül: `Orta_Büyüme_Firma ⟺ g_Firma ∈ [g_Ekonomi, g_Ekonomi + %8..10]`
  - Değişkenler: g_Firma = firmanın gelir/kazanç büyüme oranı; g_Ekonomi = faaliyet gösterilen ekonominin nominal büyüme oranı.
  - QuaxisLabs karşılığı: KISMEN UYGULANABİLİR — `revenue_growth_yoy_pct` ZATEN mevcut; g_Ekonomi (BIST için TR nominal GSYH büyümesi, NASDAQ için ABD) HİÇ makro veri kaynağı olarak çekilmiyor — düşük maliyetli bir MAKRO sabit (yıllık güncellenen, `_RISK_FREE_RATE_PCT` gibi) olarak eklenebilir, ayrı bir fetcher GEREKTİRMEZ.
- FORMÜL-177: Devir Hızı/Emsal Çarpan Regresyonu R² (En İyi Çarpan Seçimi)
  - Formül: `R²_Çarpan_i = Regresyon(Çarpan_i ~ Temel_Değişkenler)` — en yüksek R²'ye sahip çarpan, sektörde EN İYİ AÇIKLAYICI çarpan olarak seçilir.
  - Değişkenler: Temel_Değişkenler = ROE, büyüme, risk gibi çarpanı açıklaması beklenen firma-temel değişkenleri.
  - QuaxisLabs karşılığı: VERİ EKSİK (mimari) — çok-firma regresyon/istatistik altyapısı QuaxisLabs'ta hiç YOK (Kısım 4-5'te tespit edilen "çok-firma karşılaştırma altyapısı yok" kategorisinin bu bölümde 3. kez TEKRARI, artık kitap genelinde en sık tekrarlanan MİMARİ [veri-dışı] eksiklik).
- FORMÜL-178: Kesinlik Eşdeğeri (Certainty Equivalent) Dönüşümü
  - Formül: `Kesinlik_Eşdeğeri_Nakit_Akışı < Beklenen_Nakit_Akışı`, iskonto oranı bu durumda `r_f` (risksiz oran) OLMALIDIR (riskli iskonto oranıyla BİRLİKTE kullanılmamalıdır — çifte risk ayarlaması hatası).
  - Değişkenler: örnek — beklenen nakit akışı $125M ise, daha belirsiz bir nakit akışı için kesinlik eşdeğeri $100M gibi daha düşük bir risksiz-eşdeğer nakit akışına indirilir.
  - QuaxisLabs karşılığı: UYGULANAMAZ — QuaxisLabs GELECEK nakit akışı PROJEKSİYONU üretmiyor (geçmiş/güncel veriye dayalı bir tarama/skorlama motoru), bu formül YALNIZCA ileri-projeksiyonlu bir DCF modelinde anlam kazanır; kavramsal olarak Kısım 1'de not düşülen "β=1/basit Gordon modeli zaten yaklaşık" sınırlamasıyla İLİŞKİLİDİR ama AYRI bir uygulama gerektirmiyor.

### Eşikler

| Metrik | Eşik/Değer | Yorum | Kaynak bölüm |
|---|---|---|---|
| Dolaylı iflas maliyeti (indirect bankruptcy cost) | Firma değerinin %10-25'i (Opler&Titman 1994 sentezi; Andrade&Kaplan 1998: %10-23) | Doğrudan tasfiye maliyetinden genelde BÜYÜK | Consequences of Distress |
| Kahl (2001) — ABD firmaları 1980-1983 | 1.346 firma faiz ödemesinde zorlandı; 151 firma resmi olarak "sıkıntılı" (borç yeniden yapılandırma müzakeresinde) | Dar tanım (Chapter 11) vs geniş tanım (ödeme zorluğu) farkı BÜYÜK | Possibility of Distress |
| Sıkıntılı firmaların Chapter 11'e giriş oranı | Sıkıntılı firmaların yarısından AZI | Sıkıntı ≠ resmi iflas | Possibility of Distress |
| Chapter 11'e giren firmaların bağımsız hayatta kalma oranı | Yaklaşık 1/3 | Kalan 2/3'ü satın alınıyor veya tasfiye ediliyor | Possibility of Distress |
| Global Crossing (2001) — 12% kupon, 8 yıl vade tahvil fiyatı | $653 (yüz değer $1.000 varsayımıyla) | Tahvil-fiyatı-bazlı olasılık çıkarımı girdisi | Illustration 17.1 |
| Global Crossing — 10 yıllık kümülatif iflas olasılığı (tahvil fiyatından) | %76,63 | Aynı zamanda hayatta kalma olasılığı %23,37 | Illustration 17.1/17.7 |
| Global Crossing — CCC kredi notu, 10 yıllık kümülatif temerrüt olasılığı (Tablo 17.1'den) | %51,38 | Tahvil-fiyatı-bazlı tahminden (%76,63) BELİRGİN DÜŞÜK — yöntem farkı büyük sonuç farkı yaratabilir | Based on Bond Rating |
| Global Crossing — sıkıntı satış değeri varsayımı | Nakit-dışı varlıkların defter değerinin %15'i (PSInet emsali: <%10) | Aynı sektörde çoklu sıkıntılı firma varlığı, satış fiyatını daha da BASKILAR | Illustration 17.2 |
| Global Crossing — sürekli-firma (going concern) özkaynak değeri | Hisse başı $3,22 | Sıkıntı hiç dahil edilmeden hesaplanan DCF değeri | Illustration 17.3 |
| Global Crossing — sıkıntı dahil (sınırsız sorumluluk) özkaynak değeri | Hisse başı $0,32 | Sınırlı sorumluluk düzeltmesi YAPILMADAN | Illustration 17.3 (Dealing with Distress) |
| Global Crossing — sınırlı sorumluluk ağırlıklı özkaynak değeri | Hisse başı $0,75 | $0,32 ile $0,75 arasındaki fark, SINIRLI SORUMLULUĞUN kendisinin somut değeri | Illustration 17.3 |
| Global Crossing — ileri çarpan + sıkıntı ağırlıklı değer | Hisse başı $0,24 | FD/FAVÖK 7,2x sağlıklı-emsal çarpanı + %76,63 sıkıntı olasılığı ağırlıklı | Illustration 17.7 |
| Global Crossing — piyasa D/C oranı (2001 sonu) | Yüksek (özkaynak piyasa değeri $1.649M'ye karşı borç defter değeri $7.647M / piyasa değeri $4.923M) | Aşırı kaldıraç, iskonto oranı/beta girdisini ÇARPITIYOR | Illustration 17.3 |
| Eurotunnel (1997) — borç oranı | %95,35 (2002'ye kadar %70'e düşürüleceği varsayıldı) | Aşırı kaldıraçlı altyapı firması örneği | Illustration 17.12 |
| Eurotunnel — toplam borç yükümlülüğü (kupon dahil) | £8.865M (yüz değer £5.000M+) | Kupon+faiz eklenince yükümlülük ~%77 ARTIYOR | Illustration 17.12 |
| Eurotunnel — özkaynak opsiyon modeli sonucu vs piyasa fiyatı | Model değeri hesaplanan opsiyon değeri; piyasada £150M'den işlem görüyordu | Opsiyon çerçevesi negatif defter özkaynağına (−£117M) rağmen POZİTİF piyasa değerini AÇIKLAYABİLİYOR | Illustration 17.12 |
| Illustration 17.8 — örnek opsiyon modeli girdileri | Firma değeri $100M, varlık oynaklığı %40, borç yüz değeri $80M (10 yıl sıfır kupon), risksiz oran %10 | Standart ders-kitabı örneği, Merton modelinin girdi yapısıyla BİREBİR eşleşir | Illustration 17.8 |
| Illustration 17.9 — özkaynağın değerini koruduğu alt sınır | Firma değeri $10M'a (borç yüz değerinin çok altına) düşse bile özkaynak POZİTİF değer taşımaya devam ediyor | Opsiyon zaman priminin somut gösterimi | Illustration 17.9/Figure 17.2 |
| "Orta büyüme" tanımı (nominal ekonomi büyümesine göre bant) | Ekonomi büyüme oranının +%8 ile +%10 fazlası arası | Bu bandın ÜSTÜ "yüksek büyüme" (3-aşamalı model gerektirir) sayılır | Growth Momentum |

**Tablo 17.1 — Kredi Notu ve Kümülatif Temerrüt Olasılığı (1971-2001, Altman&Kishore 2001)**

| Kredi Notu | 5 Yıl Kümülatif Temerrüt Olasılığı | 10 Yıl Kümülatif Temerrüt Olasılığı |
|---|---|---|
| AAA | %0,03 | %0,03 |
| AA | %0,18 | %0,25 |
| A+ | %0,19 | %0,40 |
...
*QuaxisLabs karşılığı (Tablo 17.1): VERİ EKSİK — hiçbir hisse için kredi notu (bond/issuer rating) çekilmiyor; grep ile `src/fetchers/isyatirim.py`, `src/fetchers/kap.py`, `src/fetchers/kap_financials.py`, `src/fetchers/sec_edgar.py` içinde "rating"/"kredi notu" alanı bulunamadı — bu tablo şu an SADECE referans/gelecekteki bir kredi-notu-fetcher'ı için bir hedef eşleştirme şablonu olarak kayda geçirilmiştir.*

**Tablo 18.1 — Sektöre Göre En Yaygın Kullanılan Çarpan**

| Sektör | Kullanılan Çarpan | Gerekçe |
|---|---|---|
| Döngüsel imalat | F/K, göreli F/K | Genelde normalleştirilmiş kazançla |
| Yüksek teknoloji / yüksek büyüme | F/K-Büyüme (PEG) | Firmalar arası büyüme farkı F/K'yı direkt kıyaslanamaz kılar |
| Yüksek büyüme / negatif kazanç | Fiyat/Satış, FD/Satış | Gelecekteki marjların pozitif olacağı varsayılır |
| Altyapı | FD/FAVÖK | Erken yıllarda zarar + amortisman yöntemine göre değişen raporlanan kazanç |
| Gayrimenkul | Fiyat/Nakit Akışı | Yatırım politikası kısıtları + büyük amortisman özkaynak kazancını bozar |
| Finansal hizmetler | Fiyat/Defter Değeri | Defter değeri genelde piyasaya göre işaretlenir (marked to market) |
| Perakendecilik | Fiyat/Satış veya FD/Satış | Kaldıraç benzerse P/S, farklıysa FD/Satış |

*QuaxisLabs karşılığı (Tablo 18.1): KISMEN MEVCUT — `pe_ratio`, `ev_ebitda`, `ev_revenue`, `pb_ratio` (PEG dahil, Kısım 4 bulguları) hepsi ZATEN hesaplanıyor; SEKTÖRE GÖRE hangi çarpanın öncelikli gösterileceğine dair bir "sektör → önerilen çarpan" eşleme kuralı YOK — bu, `sektor-siniflandirma` skill'inde tanımlı sektör evreniyle BİRLEŞTİRİLEBİLECEK düşük-maliyetli bir sunum/önceliklendirme kuralı (yeni veri gerektirmez).*

### Kontrol listeleri

**LL — Sıkıntı Maliyetini Değerlemeye Dahil Etme Kontrol Listesi (Ch.17)**
1. Firma önemli miktarda borç taşıyor mu VEYA faaliyet zararı/negatif nakit akışı raporluyor mu (sıkıntı riskinin ÖN-TARAMASI)?
2. Sıkıntı olasılığını tahmin etmek için hangi yöntem UYGUN — istatistiksel (Z-Score/probit), kredi-notu-bazlı, tahvil-fiyatı-bazlı, yoksa opsiyon-fiyatlama-bazlı (Merton) mı?
3. Sıkıntı satış değeri nasıl tahmin edilecek — DCF değerinin bir yüzdesi mi, sadece mevcut yatırımların perpetuite değeri mi, yoksa emsal sıkıntılı firmaların defter-değeri-yüzdesi mi?
4. Modifiye DCF mi (tek bir harmanlanmış nakit akışı) yoksa ayrı değerleme mi (sürekli-firma + sıkıntı satışı ayrı ayrı) tercih edilecek?
5. İskonto oranı girdileri (beta, borç maliyeti) GÜNCEL (yüksek) piyasa koşullarını mı yansıtıyor, yoksa geçmişe dönük/hedef-oran varsayımlarıyla mı YANLIŞ ŞEKİLDE hesaplanıyor?
6. Borç oranı varsayımı, sabit sektör/hedef ortalaması mı yoksa güncel-yüksek-orandan kademeli iyileşme mi?
7. Özkaynak sınırlı sorumluluk düzeltmesi (max(0, ...) terimi) uygulandı mı, yoksa sıkıntı senaryosunda negatif özkaynak değeri gibi ANLAMSIZ bir sonuç mu üretiliyor?
8. Firma derin sıkıntıdaysa (borç yüz değeri firma değerine yakın/üstünde), opsiyon-fiyatlama (equity-as-option) modeli standart DCF'e ALTERNATİF olarak değerlendirildi mi?
9. Göreli değerlemede F/K veya PD/DD hesaplanamıyorsa (negatif kazanç/özkaynak), FD/FAVÖK veya FD/Satış'a geçildi mi?
10. Sıkıntı iskontosu SÜBJEKTİF bir analist yargısı mı, yoksa kredi-notu-sınıfı bazlı OBJEKTİF bir çarpan farkına mı dayanıyor?

**MM — Değerleme Modeli Seçim Kontrol Listesi (Ch.18, Figure 18.2-18.7 sentezi)**
1. Varlıklar AYRILABİLİR ve bağımsız satılabilir mi (evet → tasfiye/yenileme-maliyeti modelleri UYGULANABİLİR)?
2. Varlık hangi nakit-akışı grubunda — (a) şimdi/yakında üretiyor (DCF), (b) koşullu/gelecekte üretebilir (opsiyon fiyatlama), (c) hiçbir zaman üretmeyecek (sadece göreli değerleme)?
3. Firma/varlık için YETERLİ sayıda gerçek EMSAL var mı (evet → göreli değerleme güvenilir; hayır → DCF'e ağırlık ver)?
4. Analiz UFKU ne kadar uzun (uzun ufuk → DCF; kısa ufuk → göreli değerleme)?
5. Değerlemenin AMACI nedir — İçsel değer arayışı mı (DCF) yoksa sektöre göre göreli konum mu (çarpan)?
6. Firma MEVCUT yönetimle mi yoksa OPTİMAL yönetimle mi değerlenmeli — bu, yatırımcının kontrol/etki gücüne bağlı mı belirlendi?
7. DCF ve göreli değerleme AYNI YÖNDE mi işaret ediyor (ikisi de ucuz/pahalı), yoksa ÇELİŞİYOR mu (sektör yanlış fiyatlanmış olabilir)?
8. Opsiyon fiyatlama kullanılacaksa: firma KÜÇÜK ve opsiyon-benzeri varlık ağırlıklı mı, gerçek bir DIŞLAYICILIK (yasal/rekabetçi) var mı, ve bu opsiyon değeri DCF büyüme varsayımında ZATEN dolaylı olarak sayılmış mı (çifte sayım kontrolü)?

**NN — Değerlemeyi İyileştirmenin On Adımı (Ten Steps to Better Valuations, Ch.18)**
1. Değerleme sürecindeki ÖNYARGIYI en aza indir — şirketin ucuz/pahalı olduğuna dair önceden güçlü görüşü olan veya ücreti/performansı sonuca bağlı analistlerin değerlemesi bu önyargıyı YANSITIR; modeli iyileştirmek bu sorunu ÇÖZMEZ.
2. TUTUMLU (parsimonious) modeller kullan — daha az girdi gerektiren basit modeller, karmaşık modellerin sağladığı yanıltıcı hassasiyet YANILSAMASINDAN daha güvenilirdir.
3. Ekonominin TEMEL yasalarına saygı göster — hiçbir firma sonsuza kadar ekonomiden daha hızlı büyüyemez; bu varsayımı yapan her model YANLIŞTIR.
4. Nakit akışlarını iskonto oranlarıyla EŞLEŞTİR — özkaynak maliyetiyle firma nakit akışını, nominal oranla reel nakit akışını, veya bir para biriminin nakit akışını başka bir para biriminin iskonto oranıyla İSKONTOLAMAK her zaman YANLIŞ sonuç verir.
5. İÇ TUTARLILIĞI koru — büyüme, risk ve yeniden-yatırım varsayımları BİRBİRİYLE UYUMLU olmalı (yüksek büyüme+düşük yeniden-yatırım+düşük risk kombinasyonu GERÇEKÇİ DEĞİLDİR).
6. MAKROEKONOMİK görüşleri değerlemenin DIŞINDA tut — faiz oranı/döviz kuru beklentilerini değerlemeye gömmek, sonucun ne kadarının FİRMAYA ne kadarının MAKRO görüşe ait olduğunu AYIRT EDİLEMEZ hale getirir.
7. "Değerleme süslemesinden" (valuation garnishing) KAÇIN — kontrol/likidite/maddi-olmayan-varlık gibi etkenleri modelin İÇİNE gömmek gerekir, sonuca keyfi +/-%20 gibi düz bir prim/iskonto EKLEMEK değil.
8. Hiçbir iki firmanın TAMAMEN AYNI olmadığını unutma — "karşılaştırılabilir firma" kavramı ÖZNELDİR, göreli değerleme yargısını her zaman RENKLENDİRİR.
9. Bir HİKAYE anlat ama VERİYE de bak — hikaye anlatmak insan doğasıdır ama sadece önyargıları haklı çıkarmak için kullanılırsa TEHLİKELİDİR; veri hem hikayenin MANTIKLI olup olmadığını sınamalı hem de DETAYLARI doldurmalıdır.
10. "Saflardan" (purists) SAKIN — hiçbir yaklaşım/model MUTLAK kural değildir; körü körüne bir denklemi/modeli takip etmek felakete götürür — pragmatizm, sağduyu ve uyarlanabilirlik en iyi analizi karakterize eder.

### Kırmızı bayraklar

- BAYRAK-72: Terminal Değer Ağırlıklı + Sıkıntı-Kör DCF — Nasıl tespit edilir: bir DCF değerlemesinde toplam değerin BÜYÜK kısmı terminal değerden geliyorsa VE firma yüksek kaldıraç/negatif marj taşıyorsa, standart model iflas riskini YETERİNCE YANSITMIYOR olabilir (İLKE-408/413). — Gereken veri: net_debt_to_ebitda (mevcut), terminal değerin toplam değere oranı (valuation.py'de AYRIŞTIRILMIYOR, sadece nihai fiyat üretiliyor — ara katman yok).
- BAYRAK-73: Hedef/Sektör-Ortalama Borç Oranı Varsayımıyla Aşırı Kaldıraçlı Firma Değerleme — Nasıl tespit edilir: güncel piyasa D/C oranı sektör ortalamasının ÇOK ÜZERİNDEYSE ve model yine de sektör-ortalama borç oranıyla iskonto oranı hesaplıyorsa, değer SİSTEMATİK OLARAK ŞİŞER (İLKE-421). — Gereken veri: piyasa değerli D/C (kısmen mevcut, `debt_to_equity` DEFTER değerli — bkz. FORMÜL-174), sektör ortalama D/C (çok-firma karşılaştırma altyapısı yok).
- BAYRAK-74: Kısa-Pencere Regresyon Betası ile Hızla Kötüleşen Firma — Nasıl tespit edilir: firmanın son 6-12 ayda kaldıraç/kârlılığı HIZLA kötüleşmişse, 2-5 yıllık geçmiş fiyata dayalı bir regresyon betası gerçek riski OLDUĞUNDAN DÜŞÜK gösterir (Enron 2001 örneği, İLKE-417). — Gereken veri: QuaxisLabs regresyon betası HİÇ hesaplamıyor (pazar endeksi getiri serisi yok) — bu bayrak şu an TEORİK, β eklenene kadar tetiklenemez.
- BAYRAK-75: Tahvil YTM'sinin Doğrudan Borç Maliyeti Olarak Kullanılması — Nasıl tespit edilir: yüksek temerrüt riski taşıyan bir firma için VAADEDİLEN nakit akışına dayalı YTM, borç maliyeti girdisi olarak KULLANILIYORSA maliyet AŞIRI ŞİŞER (İLKE-418). — Gereken veri: QuaxisLabs tahvil YTM verisi hiç ÇEKMİYOR — bu bayrak QuaxisLabs kapsamı DIŞINDA (hisse odaklı mimari).
- BAYRAK-76: F/K veya PD/DD Hesaplanamıyor Ama FD/FAVÖK Hesaplanabiliyor — Nasıl tespit edilir: bir hissede `pe_ratio`/`pb_ratio` None veya ANLAMSIZ (negatif kazanç/özkaynak) iken `ev_ebitda`/`ev_revenue` GEÇERLİ değer üretiyorsa, bu DURUMUN KENDİSİ bir sıkıntı sinyalidir (İLKE-435). — Gereken veri: TÜMÜ ZATEN MEVCUT (`pe_ratio`, `pb_ratio`, `ev_ebitda`, `ev_revenue`) — **en düşük maliyetli somut bulgu, SIFIR yeni veri, sadece bir karşılaştırma/etiketleme kuralı.**
- BAYRAK-77: Sübjektif "Sıkıntı İskontosu" Gerekçesi (Nitel) — Nasıl tespit edilir: bir yönetim açıklaması/analist yorumunda "sektöre göre ucuz ama sıkıntı riski nedeniyle haklı" gibi SAYISALLAŞTIRILMAMIŞ bir gerekçe varsa, bu ÖNYARGI riski taşır (İLKE-435). — Gereken veri: dipnot/metin fetcher'ı (QuaxisLabs'ta hiç YOK — kitap genelinde 4. kez tekrarlanan mimari eksiklik, bkz. Kısım 6/8a/8b).
- BAYRAK-78: Defter Değerli Borçla Hesaplanan Net Borç/FD (Sıkıntılı Firmada) — Nasıl tespit edilir: net_debt_to_ebitda veya enterprise_value yüksek EDF'li (sıkıntılı) bir firma için hesaplanıyorsa, borcun DEFTER değeri (mevcut `net_debt()` implementasyonu) o firmanın borcunun GERÇEK (piyasa) risk-ayarlı değerinden ÇOK FARKLI olabilir (İLKE-438/439, FORMÜL-174). — Gereken veri: borcun piyasa değeri (tahvil fiyatı) — QuaxisLabs'ta yok, ama Merton modeli (varsa entegre edilirse) örtük borç değerini (Firma_Değeri−Özkaynak) YAN ÜRÜN olarak zaten üretiyor.
- BAYRAK-79: Merton EDF ile DCF Modelinin BAĞLANTISIZLIĞI (Mimari) — Nasıl tespit edilir: `src/analysis/merton.py::compute_merton_dd_edf()` DOĞRU çalışıp yüksek bir temerrüt olasılığı üretse BİLE, AYNI firma için `valuation.py::compute_valuation_assessment()` (Damodaran FCFE) bu bilgiden HİÇ HABERDAR DEĞİL ve %0 sıkıntı olasılığı varsayan standart bir "sürekli firma" değeri üretmeye devam ediyor — grep ile doğrulandı, `compute_merton_dd_edf` PROJENİN HİÇBİR yerinde (`merton.py` dışında) çağrılmıyor. — Gereken veri: HİÇBİRİ EKSİK DEĞİL, SADECE İKİ MEVCUT modülü birbirine BAĞLAYAN bir orkestrasyon katmanı eksik — **kitap genelinde tespit edilen EN DÜŞÜK MALİYETLİ mimari bulgulardan biri.**
- BAYRAK-80: Negatif Kazanç/ROE Nedeniyle Sessizce None Dönen DCF (Alternatif Model Yönlendirmesi Yok) — Nasıl tespit edilir: `valuation.py::compute_valuation_assessment()` `ttm_net_income<=0` veya `roe_pct<=0` durumunda Damodaran FCFE bloğunu SESSİZCE atlıyor (None döner) — bu Damodaran'ın kendi tavsiyesiyle (İLKE-461: negatif kazançta standart DCF UYGUNSUZ) TUTARLI bir davranış, ANCAK kullanıcıya "bu firma için ALTERNATİF bir model (opsiyon fiyatlama/Merton EDF, veya normalleştirilmiş-kazanç DCF) değerlendirilmeli" YÖNLENDİRMESİ hiç YAPILMIYOR — kod DOĞRU davranıyor ama SESSİZ kalıyor. — Gereken veri: HİÇBİRİ EKSİK DEĞİL — sadece bir mesaj/yönlendirme metni eklemek yeterli.
- BAYRAK-81: Kredi Notu/Temerrüt Olasılığı Verisi Tamamen Yok (Yapısal) — Nasıl tespit edilir: Tablo 17.1 (kredi notu → temerrüt olasılığı) türü bir eşlemeyi UYGULAMAK için gereken kredi notu alanı grep ile `isyatirim.py`/`kap.py`/`kap_financials.py`/`sec_edgar.py` içinde ARANDI, BULUNAMADI — bu, Kısım 1/3'te (Tablo 2.4/Tablo 6.2, sentetik kredi notu formülleri) tespit edilen açığın Kısım 9'da 3. kez DOĞRULANMASI. — Gereken veri: harici bir kredi derecelendirme API'si (Fitch/S&P/Moody's) VEYA Merton EDF'den TÜRETİLMİŞ bir "sentetik kredi notu" (kitabın Ch.2'de önerdiği interest-coverage-bazlı sentetik nota benzer, ama interest_expense XI_29'da yok — bkz. BAYRAK-82).
- BAYRAK-82: Sanayi/Ticaret Şirketlerinde Faiz Gideri Hâlâ Yok (KAP_FINANCIALS.PY Yeni Fetcher'ında Bile) — Nasıl tespit edilir: `interest_expense` alanı `STANDARD_ITEM_MAP_KAP_XI_29_INCOME` haritasında ARANDI (grep ile), sadece `STANDARD_ITEM_MAP_KAP_UFRS_INCOME` (BANKA şeması) içinde bulundu — sanayi/ticaret (XI_29) şirketleri için interest_expense HÂLÂ eksik, faiz karşılama oranı (interest coverage) ve APV vergi-avantajı hesapları (FORMÜL-166) bu YÜZDEN bloke. — Gereken veri: KAP XBRL taxonomy'sinde XI_29 gelir tablosu için "ifrs-full_FinanceCosts" veya benzeri bir tag araştırması (kap_financials.py YAZARI için somut bir sonraki adım).
- BAYRAK-83: Tasfiye/Sıkıntı Bağlamında Negatif Özkaynağın Standart PD/DD Boru Hattından Geçmesi — Nasıl tespit edilir: özkaynağı (equity) negatif olan bir firma için `pb_ratio` hesaplanmaya çalışılırsa ya None ya da işareti YANLIŞ YORUMLANABİLECEK negatif bir sayı üretir; bu durumun KENDİSİ (negatif defter özkaynağı) opsiyon-teorik bir sinyaldir (Eurotunnel örneği, İLKE-441/442: negatif defter özkaynağına RAĞMEN pozitif piyasa değeri NORMALDİR) — standart oran ekranı bunu bir "hata/anlamsız veri" gibi göstermemeli, AYRI bir "derin sıkıntı" etiketiyle işaretlemelidir. — Gereken veri: `equity` alanı ZATEN mevcut, sadece bir eşik/etiketleme kuralı eksik.

### Uygulama notları (koda dönüşüm için)

**Nicel (skorlanabilir, kısmen mevcut veriyle):**
- FORMÜL-164 (Nakit Yakma Oranı) — `cash` ve FAVÖK ZATEN mevcut, negatif FAVÖK'lü şirketler için SIFIR yeni veriyle `calculator.Ratios`'a eklenebilir. **Kısım 9'un en düşük maliyetli somut önerisi.**
- BAYRAK-76 (F/K yok ama FD/FAVÖK var → sıkıntı sinyali) — dört alan da (`pe_ratio`, `pb_ratio`, `ev_ebitda`, `ev_revenue`) ZATEN mevcut, sadece bir karşılaştırma/etiketleme kuralı eksik.
- BAYRAK-79/80 (Merton↔DCF köprüsü + None-durumunda yönlendirme mesajı) — **hiçbir yeni veri gerektirmeyen, SADECE mevcut iki modülü (merton.py + valuation.py) birbirine bağlayan bir orkestrasyon değişikliği** — kitap genelinde tespit edilen en yüksek-etki/en-düşük-maliyetli mimari bulgu.
- FORMÜL-176 (orta-büyüme ekonomi-bandı) — `revenue_growth_yoy_pct` mevcut; sadece TR/ABD nominal GSYH büyümesi için `_RISK_FREE_RATE_PCT` benzeri statik/periyodik-güncellenen bir makro sabit eklenmesi yeterli.
- FORMÜL-174 (piyasa değerli D/C) — mevcut `debt_to_equity`'nin DEFTER değerli olduğu zaten belgeli (Kısım 8b); bu formül aynı açığın sıkıntı bağlamındaki SOMUT sonucunu gösteriyor, yeni bir açık değil.
- Tablo 18.1 (sektöre göre önerilen çarpan) — mevcut 4 çarpan (`pe_ratio`, `pb_ratio`, `ev_ebitda`, `ev_revenue`/PEG) `sektor-siniflandirma` skill'indeki sektör evrenine eşlenerek düşük-maliyetli bir "öncelikli çarpan" sunum kuralı üretilebilir.

**Nitel (LLM yorumuna uygun):**
- BAYRAK-77 (sübjektif sıkıntı iskontosu gerekçesi) ve Kontrol Listesi LL/MM/NN'nin büyük kısmı (özellikle NN'nin 1/6/7/9. maddeleri — önyargı, makro görüş sızması, süsleme, hikaye-veri dengesi) DOĞRUDAN sayısal taranamaz; bir "değerleme metodolojisi denetim" LLM görevi için ŞABLON olarak kullanılabilir — bu, kitap genelinde 4. kez tekrarlanan "dipnot/metin fetcher'ı yok" temasıyla AYNI kategoriye girer.
- BAYRAK-73/75 (D/C ve YTM ile ilgili bayraklar) kısmen nitel kalır çünkü GEREKLİ ham veri (piyasa değerli borç, tahvil fiyatı) yapısal olarak eksik; bu bayraklar veri eklenene kadar ancak bir ANALİST NOTU/UYARI METNİ olarak (sayısal tetikleme olmadan) sunulabilir.

**Uygulanamaz (veri/mimari eksikliği nedeniyle şimdilik dışarıda):**
- FORMÜL-170 (tahvil fiyatından zımni temerrüt olasılığı), FORMÜL-165/166/167/168 (APV ailesinin TAMAMI) — WACC/kaldıraçsız beta/interest_expense (XI_29)/tahvil fiyatı YOK; Kısım 3'te (Ch.6) tespit edilen "APV/FCFF ailesi TAMAMEN kapsam dışı" bulgusunun 2. kez doğrulanması.
- FORMÜL-160/161/162/163 (sıkıntı-ağırlıklı DCF/özkaynak formülleri) — yıllık/kümülatif sıkıntı olasılığı serisi ve sıkıntı-satış-değeri girdileri YOK; Merton EDF TEK bir ufuk-anı yaklaşımı sunar, kitaptaki ÇOK-YILLI seri YAKLAŞIMININ YERİNİ TUTMAZ (ancak BAYRAK-79'daki köprü kurulursa KISMEN bir alternatif sunabilir).
- Tablo 17.1 (kredi notu → temerrüt olasılığı eşlemesi) ve BAYRAK-81/82 — kredi notu ve XI_29 faiz gideri verisi YOK; harici bir kredi derecelendirme kaynağı veya yeni bir KAP XBRL tag araştırması olmadan uygulanamaz.
- FORMÜL-177 (çok-firma çarpan regresyonu/R²) — çok-firma istatistik altyapısı hiç YOK (Kısım 4-5-9'da 3. kez tekrarlanan mimari kategori).
- FORMÜL-178 (kesinlik eşdeğeri) — QuaxisLabs geleceğe dönük nakit akışı projeksiyonu ÜRETMİYOR, kavram bu mimaride anlam kazanmıyor.

### Kısım 9 — özel notlar

- **En önemli mimari bulgu (kitap genelinde en yüksek-etki/en-düşük-maliyetli):** `src/analysis/merton.py::compute_merton_dd_edf()` (Kısım 6'da FORMÜL-121 için ilk tespit edilen Black-Scholes/Merton çekirdeği) Ch.17'nin "özkaynak bir opsiyondur" merkezi tezinin NEREDEYSE TAM bir kod karşılığıdır — girdi tersine çevrilmiş (kitap A/σ_A'dan Özkaynağa gider, `merton.py` Özkaynak/σ_Özkaynak'tan A/σ_A'yı geri çıkarır) ama matematiksel çekirdek AYNIDIR. Grep ile DOĞRULANDI ki bu fonksiyon PROJENİN HİÇBİR YERİNDE (`merton.py` dosyasının kendisi dışında) çağrılmıyor — ne `card.py`, ne `deep_card.py`, ne `valuation.py`, ne `scorer.py`. Bu, kitap genelinde şimdiye kadar tespit edilen EN SOMUT "veri zaten var, sadece BAĞLANMAMIŞ" bulgusudur (BAYRAK-79/80) — sıfır yeni fetcher, sıfır yeni ham veri, sadece iki mevcut modülü birleştiren bir orkestrasyon katmanı gerektiriyor.
- **interest_expense açığı 6. kez doğrulandı, YENİ fetcher'da BİLE çözülmemiş:** `src/fetchers/kap_financials.py` (Kısım 9'da İLK kez incelenen, önceki turlarda mevcut olmayan/incelenmeyen YENİ bir fetcher — KAP XBRL'den doğrudan çekim yapıyor) `interest_expense`'i SADECE `STANDARD_ITEM_MAP_KAP_UFRS_INCOME` (banka şeması) içinde tanımlıyor; `STANDARD_ITEM_MAP_KAP_XI_29_INCOME` (sanayi/ticaret şeması) içinde YOK — Kısım 1/2/3/7'de `isyatirim.py` için tespit edilen AYNI açık, PROJENİN YENİ ve DAHA GÜVENİLİR (XBRL taxonomy bazlı) fetcher'ında bile TEKRARLANMIŞ. Bu, açığın `isyatirim.py`'nin opak itemCode şemasından değil, muhtemelen TFRS interim raporlama pratiğinin KENDİSİNDEN (sanayi şirketleri faiz giderini ayrı bir gelir tablosu satırı olarak SUNMUYOR) kaynaklandığını düşündürüyor — çözüm için KAP bildirim sayfasında "Finansman Giderleri" alt kalemlerinin taranması gerekebilir, mevcut mimari araştırmanın ÖTESİNDE bir konu.
- **WACC/APV/kaldıraçsız-beta eksikliği Ch.17'de 2. kez (Kısım 3'ten sonra) doğrulandı, bu kez mali sıkıntı bağlamında:** Kısım 3'te (Ch.6 Firm Valuation) "FCFF/WACC/APV ailesinin TAMAMI kapsam dışı" tespit edilmişti; Ch.17'nin APV-bazlı iflas-maliyeti ayrıştırması (FORMÜL-165-168) AYNI eksikliğe bağımlı — WACC eksikliği artık kitap genelinde (Kısım 1/3/5/6/7/9) 6. kez, farklı bağlamlarda doğrulanan EN SIK TEKRARLANAN tekil mimari açık olarak KESİNLEŞTİ.
- **Yeni/dördüncü tür bulgu — "veri var ama BAĞLANMAMIŞ" kategorisi:** Önceki kısımlarda 3 eksiklik kategorisi netleşmişti: (1) tekil veri eksikliği (DPS, Capex, WACC gibi), (2) çok-firma karşılaştırma altyapısı eksikliği (Kısım 4-5), (3) tek-proje-derinlik eksikliği (Kısım 6). Kısım 9, DÖRDÜNCÜ bir kategori ortaya koyuyor: (4) VERİ VE HESAPLAMA MANTIĞI ZATEN MEVCUT ama iki modül birbirine BAĞLANMAMIŞ (merton.py ↔ valuation.py) — bu, önceki 3 kategoriden farklı olarak YENİ VERİ/FETCHER GEREKTİRMEYEN, SALT KOD-ORGANİZASYONU seviyesinde bir iyileştirme fırsatıdır; muhtemelen kitap genelindeki EN UCUZ tek somut geliştirme.
- **Ch.17'nin formül yoğunluğu Kısım 1/2/3 (DCF ailesi) seviyesinde YÜKSEK kaldı** (19 formül/47 sayfa) — konunun (mali sıkıntı = borç/kaldıraç/opsiyon matematiği) doğası gereği beklenen bir örüntü; Ch.18 ise beklendiği gibi TAMAMEN kontrol-listesi/karar-ağacı ağırlıklı (3 kontrol listesi, LL/MM/NN, 24 madde toplam) ve SIFIR yeni sayısal formül içeriyor — kitabın kapanışı, sayısal hesaptan çok METODOLOJİK YARGI konusunda.
- **Global Crossing (Illustration 17.1-17.7) ve Eurotunnel (Illustration 17.12) GERÇEK, tarihsel olarak doğrulanmış şirket örnekleridir** (2001 telekom çöküşü / Manş Tüneli 1997 mali sıkıntısı) — Graham/Buffett turlarındaki "gerçek şirket vs didaktik örnek" ayrımıyla TUTARLI olarak doğrudan eşik/örnek kaynağı sayıldı; PDF'te formüllerin çoğu görsel/denklem olarak GÖMÜLÜ olduğundan (Kısım 1'den beri bilinen PDF çıkarım sınırlaması) kesin ara-sonuç sayıları (örn. APV nihai hisse-başı değeri) metin akışından ÇIKARILAMADI — sadece METODOLOJİ ve BAŞLANGIÇ/BİLİNEN ARA sonuçlar (örn. $10.346M kaldıraçsız firma değeri, $2.180M sıkıntı satış değeri) eşikler tablosuna alındı.
- **Ownership/governance açığı bu turda TEKRAR karşımıza ÇIKMADI (Ch.17-18'de doğrudan ilgisi yok)** — Kısım 7-8'de yoğun biçimde tespit edilen sahiplik yapısı/yönetişim eksikliği Ch.17'nin (borç/temerrüt) veya Ch.18'in (model seçimi) konusuyla DOĞRUDAN kesişmiyor, bu yüzden bu bölümde tekrar doğrulanmadı — kitap genelinde bu açığın en yoğun olduğu bölümler Ch.13 (Kısım 7) ve Ch.16 (Kısım 8b) olarak KALDI.
