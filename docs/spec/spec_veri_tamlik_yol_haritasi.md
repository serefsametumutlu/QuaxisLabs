...
| V-26 | Çapraz İştirak/Azınlık Payı Piyasa Değeri Listesi (BİST holding yapıları — Koç, Sabancı, Doğuş tipi) — SUM-OF-PARTS/NAV genişletmesi (V-26'nın kendisi HÂLÂ AÇIK) | Değer (Not: `pb_ratio`'nun payı/paydası kapsam uyuşmazlığı — BAYRAK-28/29 "azınlık kirliliği" — 2026-08-12'de DÜZELTİLDİ, bkz. `spec_mercek_deger.md` Kenar Durumlar; V-26 BUNDAN AYRI, DAHA GENİŞ bir istektir: her bağlı ortaklığın KENDİ piyasa değerinin toplanarak holding'in sum-of-parts NAV'ının hesaplanması) | BİST | — | YAPISAL (yüksek) | 03/Kısım 5 — konsolide holding yapılarının sum-of-parts DEĞERLENMESİ için gerekli, veri sınıfı TAMAMEN eksik |
