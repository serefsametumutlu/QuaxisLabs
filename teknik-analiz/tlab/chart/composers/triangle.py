"""Üçgen grafiği — `patterns.triangle` (simetrik/yükselen/alçalan).
...
to_pattern(WedgeIndicator("triangle")(df), df)` çağrısından gelir (bu dosya
HESAP YAPMAZ, yalnızca çizer).

Referanslar: `önemli/HRiPy4qbUAA1bKc.png` (simetrik), `önemli/
HRihBa2WIAIZjP_.png` (alçalan, numaralı temaslar).
"""
