    ...
    def compute(self, df: pd.DataFrame, context: dict | None = None) -> IndicatorResult:
        ...
        for kind in kinds:
            ...
            for hs in candidates:
                ...
                # `confirm_signal()` GÜNCEL listeden yeniden arar.
                ...
                # K3 düzeltmesi (2026-09-05): DÖRT AYRI işaret -- KIRILIM/
                # ONAY/AL-SAT/HEDEF. AL/SAT artık last_sig'e DEĞİL entry_sig
                # (kırılım onayı) barına konur; formasyon geçersiz/süresi
                # dolmuşsa hiçbiri üretilmez.
                if show_entry:
